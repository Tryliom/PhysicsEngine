...
struct MatrixConstructorIntParamFixture : public ::testing::TestWithParam<std::array<Vec2I, 2>>
{
};

struct MatrixConstructorFloatParamFixture : public ::testing::TestWithParam<std::array<Vec2F, 2>>
{
};

struct MatrixIntFixture : public ::testing::TestWithParam<Mat2x2I>
{
};

struct MatrixFloatFixture : public ::testing::TestWithParam<Mat2x2F>
{
};
...
TEST_P(MatrixIntFixture, MatIntInvertedTest) {
    ...
    if (det == 0)
    {
        ...
        EXPECT_THROW(m.Inverted<float>(), DivisionByZeroException);
        return;
    }
    ...
    EXPECT_NEAR(mInv.Val[0][0], mId.Val[0][0], MathUtility::Epsilon);
    EXPECT_NEAR(mInv.Val[0][1], mId.Val[0][1], MathUtility::Epsilon);
    EXPECT_NEAR(mInv.Val[1][0], mId.Val[1][0], MathUtility::Epsilon);
    EXPECT_NEAR(mInv.Val[1][1], mId.Val[1][1], MathUtility::Epsilon);
}
