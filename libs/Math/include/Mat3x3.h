...
public:
    ...
    T Val[RowNbr][ColNbr] {{1, 0, 0}, {0, 1, 0}, {0, 0, 1}};
    ...
    NOALIAS constexpr Mat3x3<T> operator+(const Mat3x3<T>& m) const noexcept
    {
        Mat3x3<T> mResult;
    ...
    NOALIAS constexpr Mat3x3<T> operator*(const T scalar) const noexcept
    {
        Mat3x3<T> mResult;
    ...
    NOALIAS constexpr friend Mat3x3<T> operator*(const T scalar, const Mat3x3<T>& m) noexcept
    {
        return m * scalar;
    }
    ...
    NOALIAS constexpr Vec3<T> operator*(const Vec3<T> v) const noexcept
    {
        Vec3<T> vResult;
