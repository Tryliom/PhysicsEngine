...
public:
    ...
    [[nodiscard]] NOALIAS inline constexpr static Mat2x2<T> Identity() noexcept
    ...
    [[nodiscard]] constexpr Mat2x2<T> &operator+=(const Mat2x2<T> &other) noexcept
    {
    ...
    [[nodiscard]] constexpr Mat2x2<T> &operator*=(const T scalar) noexcept
    {
